...
```bash
python curvature_extension/compare_curvature_extension_sinus.py
```

Outputs go to:

- `curvature_extension_results/sinus_dnn2gp_vs_curvature_extension.png`
- `curvature_extension_results/curvature_extension_metrics.json`
...
```bash
python curvature_extension/compare_curvature_extension_mnist_small.py
```

Outputs:

- `curvature_extension_results/mnist_curvature_extension/mnist_small_dnn2gp_vs_curvature_extension.png`
- `curvature_extension_results/mnist_curvature_extension/mnist_small_curvature_extension_metrics.json`
