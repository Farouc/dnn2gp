...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint", type=str, default="artifacts/lenet5_mnist.pt")
    parser.add_argument("--output", type=str, default="artifacts/mnist_dnn2gp_laplace.png")
