...
try:
    from .utilities import compute_log_loss_gradient, compute_log_loss_hessian, sigmoid, is_psd, identity
    from .neural_networks import SimpleMLP, WilliamsNN, SimpleConvNet
except ImportError:
    from utilities import compute_log_loss_gradient, compute_log_loss_hessian, sigmoid, is_psd, identity
    from neural_networks import SimpleMLP, WilliamsNN, SimpleConvNet
